...
| License | Personal Use | Modifications | Commercial/Sell |
|---------|--------------|---------------|-----------------|
| **CC0 (Public Domain)** | ✅ | ✅ | ✅ |
...
*New to printing? Start with [What Should I 3D Print First?](/what-to-3d-print-first/) or learn [Cura Settings for Beginners](/cura-settings-beginners/). Not sure which filament to use? Read [PLA vs PETG vs ABS](/pla-vs-petg-vs-abs/). For all our 3D printing content, see the [3D Printing Guide](/3d-printing-guide/).*
