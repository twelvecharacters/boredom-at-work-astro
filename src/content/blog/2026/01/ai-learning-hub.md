...
faq:
  ...
  - question: "Do I need to learn coding to use AI?"
    answer: "No. Most AI tools today are designed for non-technical users. You can be highly productive with ChatGPT, Claude, and other AI assistants without writing a single line of code."
  - question: "Which AI skill is most valuable for career growth?"
    answer: "Prompt engineering, knowing how to get good results from AI tools. It's useful regardless of your role and makes every other AI tool more effective."
  - question: "Are free AI courses actually good?"
    answer: "Yes. Google, IBM, and Microsoft offer genuinely valuable free courses. The paid versions usually just add certificates or extra projects, the core learning is the same."
  - question: "Will learning AI help me get promoted?"
    answer: "It can. Employees who demonstrate AI skills are increasingly seen as more valuable. The key is not just learning AI, but applying it visibly, solving problems, saving time, and sharing wins with your team."
---
...
**Who needs this:** Everyone in an office job
...
**Time to competency:** 20-40 hours
**Who needs this:** Managers, consultants, anyone wanting credentials
...
**Who needs this:** Developers, data scientists, technical roles
...
Read the [ChatGPT Tutorial for Beginners](/chatgpt-tutorial-beginners/). Don't just read, open ChatGPT and practice as you go. Try writing emails, summarizing documents, brainstorming ideas.

### Hours 3-4: Master Prompting
Read [Prompt Engineering in an Afternoon](/prompt-engineering-afternoon/). This is the highest-leverage skill. Good prompts get 10x better results than vague ones.
...
- **[ChatGPT Tutorial for Beginners](/chatgpt-tutorial-beginners/)**, From zero to productive in 30 minutes. The foundation everything else builds on.

- **[Prompt Engineering in an Afternoon](/prompt-engineering-afternoon/)**, The skill that makes everything else work. Learn to write prompts that get useful results.

- **[Learn AI While Looking Busy](/learn-ai-while-looking-busy/)**, Stealth learning strategies for the office. How to upskill without drawing attention.
...
- **[Best Free AI Courses](/best-free-ai-courses/)**, Our curated list of actually-free options. No hidden paywalls, no bait-and-switch.

- **[Google AI Essentials Review](/google-ai-essentials-review/)**, In-depth look at Google's certificate. Is the brand recognition worth 10 hours?

- **[Best AI Courses on Coursera](/best-ai-courses-coursera/)**, Platform breakdown: what's worth your time on Coursera specifically.
...
- **[Best AI Tools for Office Work](/best-ai-tools-office-work/)**, Curated, tested recommendations for common office tasks.

- **[Claude vs ChatGPT](/claude-vs-chatgpt/)**, The big comparison. Which AI assistant should you use? (Spoiler: depends on the task)

- **[Perplexity AI Guide](/perplexity-ai-guide/)**, The AI search engine that cites its sources. Perfect for research.

- **[Best AI Chrome Extensions](/best-ai-chrome-extensions/)**, AI that lives in your browser. Summarize pages, write emails, research faster.

- **[AI Meeting Assistants](/ai-meeting-assistants/)**, Otter.ai, Fireflies, Granola compared. Never take manual notes again.

- **[AI Writing Tools Comparison](/ai-writing-tools-comparison/)**, Grammarly vs. Jasper vs. Claude for writing tasks.

- **[Notion AI vs Obsidian AI](/notion-ai-vs-obsidian-ai/)**, AI-powered note-taking compared.
...
- **[How to Use AI at Work Safely](/how-to-use-ai-at-work-safely/)**, Policies, privacy, and best practices. Don't get fired.
...
- **[AI Skills for Promotion](/ai-skills-for-promotion/)**, Position yourself for growth. Which skills matter most?

- **[AI Certifications in a Week](/ai-certifications-in-a-week/)**, Speed-run credentials when you need proof fast.
...
3. Start [Google AI Essentials](/google-ai-essentials-review/) or [Elements of AI](/best-free-ai-courses/)

### Phase 2: Depth (Week 2-3)
1. Finish your certificate
2. Read [Claude vs ChatGPT](/claude-vs-chatgpt/), pick your main tool
3. Read [Prompt Engineering](/prompt-engineering-afternoon/)
4. Explore [Best AI Tools](/best-ai-tools-office-work/) for your specific needs
...
**Start here:**
1. Read the [ChatGPT Tutorial](/chatgpt-tutorial-beginners/) (30 min)
2. Take [Google AI Essentials](/google-ai-essentials-review/) or similar (10 hours)
3. Pick one tool from [Best AI Tools](/best-ai-tools-office-work/) for your actual work
