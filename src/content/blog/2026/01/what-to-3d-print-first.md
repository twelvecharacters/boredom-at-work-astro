...
*Having trouble printing? Check out our guide to the [10 most common 3D printing beginner mistakes](/3d-printing-beginner-mistakes/). Not sure which filament to use? See [PLA vs PETG vs ABS](/pla-vs-petg-vs-abs/) for a full comparison. Ready for more project ideas? Browse our [20 best functional 3D prints](/best-functional-3d-prints/) that solve real problems. For all our 3D printing content, visit the [3D Printing Guide](/3d-printing-guide/).*
