---
title: "25 Productive Things to Do When Bored at Work"
slug: "productive-things-bored-at-work"
description: "Turn your work downtime into career growth. Discover 25 genuinely productive things you can do when bored at work, from learning AI to updating your resume."
...
- **[Google AI Essentials](/google-ai-essentials-review/)** (10 hours) - The gold standard for beginners. Covers everything from basic concepts to practical prompting. Free to audit via [Coursera](https://coursera.org), $49 for a certificate.
...
- **[OpenAI Academy](https://openai.com/academy)** (varies) - Learn directly from the creators of ChatGPT. Free and constantly updated.
...
1. **Clean your inbox** - Archive old emails, unsubscribe from newsletters you never read, create filters for recurring messages

2. **Unsubscribe from junk** - Use a tool like Unroll.me or just manually hit unsubscribe on unwanted emails

3. **Update your passwords** - Use a password manager, enable two-factor authentication on important accounts

4. **Schedule that meeting** - The one you've been putting off. Just do it.

5. **Send a thank you note** - To someone who helped you recently. It takes 2 minutes and strengthens relationships.

6. **Review your calendar** - Look at the upcoming week. Cancel unnecessary meetings. Block focus time.

7. **Complete expense reports** - If you've been procrastinating on these, now's the time.

8. **Clean your workspace** - Physical or digital. A clean space improves focus.

9. **Update your out-of-office** - If you have vacation coming up, set it up now.

10. **Read that article** - The one you bookmarked months ago and never got to.
...
1. Learn AI skills during your downtime
2. Use AI to complete your actual work faster
3. This creates more downtime
4. Use that time to learn more
5. Become increasingly valuable
6. Get promoted
