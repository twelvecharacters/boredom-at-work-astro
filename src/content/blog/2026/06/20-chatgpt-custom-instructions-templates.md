---
title: "15 ChatGPT Custom Instructions Templates You Can Copy"
...
Best for: anyone who spends too much time drafting emails. Pairs well with [AI email writing tools](/ai-email-writing/).
...
Best for: people who live in spreadsheets and need formula help, data interpretation, or SQL queries. See also: [ChatGPT for Excel](/chatgpt-for-excel/).
...
Best for: bloggers, content marketers, and anyone publishing articles regularly. For broader AI writing tools, see this [comparison of AI writing tools](/ai-writing-tools-comparison/).
...
Best for: developers who use ChatGPT for coding, debugging, and architecture decisions. For more AI tools for technical work, check out the [best AI tools for office work](/best-ai-tools-office-work/).
...
Best for: dedicated spreadsheet work (more specific than the Data Analyst template). Deep dive: [ChatGPT for Excel guide](/chatgpt-for-excel/).
...
Best for: self-directed learners picking up new skills. For a structured approach, see the [ChatGPT guide](/chatgpt-guide/).
...
Best for: personal finance, portfolio tracking, and investment research. More finance tools: [investing tools guide](/investing-tools-guide/).
...
Best for: researching trips, building itineraries, and finding deals. For AI-powered travel planning, check out [AI trip planners](/best-ai-trip-planners/).
...
1. **Go to Settings > Personalization > Custom Instructions** in ChatGPT. Copy both fields from your chosen template. Replace the bracketed placeholders with your actual info.
