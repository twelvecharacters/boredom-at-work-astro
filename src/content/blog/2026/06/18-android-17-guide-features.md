...
| :--- | :--- | :--- |
| **Core AI** | Gemini Nano 2 (On-device) | Faster, private, proactive intelligence |
| **User Interface** | Material You 3.0 & Predictive Back | Smoother, more intuitive navigation |
| **Messaging** | Native Satellite Texting | Communication anywhere on Earth |
| **Privacy** | AI Privacy Sandbox | Your data stays on your device |
| **Performance** | ART 15 & AI Thermal Management | Longer battery life and faster apps |
| **Release Date** | June 16, 2026 | Now available for Pixels |
