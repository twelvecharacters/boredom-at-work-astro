...
faq:
  - question: "Can I change fonts on my Kindle?"
    answer: "Yes! Go to the Aa menu while reading and choose from built-in fonts. You can also sideload custom fonts by connecting via USB and adding .ttf or .otf files to the 'fonts' folder."
  - question: "How do I send documents to my Kindle?"
    answer: "Use your Send to Kindle email address (found in Settings > Your Account). Email any PDF, EPUB, DOC, or TXT file to that address and it'll appear on your Kindle within minutes."
  - question: "Does Kindle have a dark mode?"
...
If your Kindle stops holding a charge or won't power on at all, that's usually fixable. Our [Kindle won't turn on or charge](/kindle-wont-turn-on-charge/) guide covers the hard reset and charging fixes that revive most devices.
...
It's not fully custom screensavers (that still requires [jailbreaking](/kindle-modding-guide/)), but it looks much better than Amazon's default promotional images.
