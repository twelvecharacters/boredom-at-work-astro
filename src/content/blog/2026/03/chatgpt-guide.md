...
faq:
  - question: "Is ChatGPT free to use?"
    answer: "Yes, ChatGPT has a generous free tier that includes GPT-4o (the latest model), voice conversations, file uploads, and image generation. The free tier has usage limits during peak hours. ChatGPT Plus ($20/month) removes limits and adds priority access."
  - question: "What's the difference between GPT-3.5, GPT-4, and GPT-4o?"
    answer: "GPT-3.5 is the older, faster but less capable model. GPT-4 is smarter but slower. GPT-4o ('o' for 'omni') is the current flagship—as smart as GPT-4 but much faster, with native voice and vision capabilities. Free users now get GPT-4o."
  - question: "Can ChatGPT access the internet?"
    answer: "Yes, ChatGPT can browse the web for current information. It automatically searches when needed, or you can explicitly ask it to look something up. For research-heavy tasks, Perplexity AI may be more thorough."
  - question: "Is ChatGPT safe to use at work?"
    answer: "Generally yes, with precautions. Don't paste confidential data, proprietary code, or personal information. Check if your company has an AI policy. For sensitive work, consider ChatGPT Enterprise or Team plans with enhanced privacy."
  - question: "What can't ChatGPT do?"
    answer: "ChatGPT can't access your local files (unless you upload them), control your computer, remember past conversations (unless you enable Memory), or guarantee 100% accurate information. Always verify important facts."
  - question: "Should I pay for ChatGPT Plus?"
    answer: "Pay if you: hit free tier limits regularly, need faster responses during peak hours, want priority access to new features, or use it for work 1+ hours daily. For casual use, the free tier is excellent."
...
**Deep dive:** [ChatGPT Tutorial for Beginners](/chatgpt-tutorial-beginners/) covers all the basics step-by-step.
...
**Deep dive:** [ChatGPT Plus vs Free: Is $20/Month Worth It?](/chatgpt-plus-vs-free/)
...
**For Excel specifically:** [ChatGPT for Excel: The Complete Guide](/chatgpt-for-excel/)
...
**The process:**
1. Give context: "I need to email my manager about pushing back a deadline"
2. Get a draft
3. Refine: "Make it more apologetic" or "Shorter please"
4. Copy, personalize, send
...
**The process:**
1. Start broad: "What are the main trends in [industry] for 2026?"
2. Go deeper: "Tell me more about trend #2"
...
**For automated meeting notes:** [AI Meeting Assistants](/ai-meeting-assistants/)

### Workflow 4: Content Creation

**The process:**
1. Brainstorm: "Give me 10 blog post ideas about [topic]"
2. Outline: "Create an outline for idea #3"
3. Draft: "Write the introduction" / "Expand section 2"
4. Edit: "Make this more engaging" / "Simplify the language"
5. Polish: Use a dedicated writing tool for final editing

**Important:** ChatGPT drafts, you edit. Never publish AI content without human review and your own expertise added.

**More on AI writing:** [AI Writing Tools Comparison](/ai-writing-tools-comparison/)
...
3. "Create a summary table of sales by region"
4. "Write an Excel formula to calculate monthly growth rate"

**Deep dive:** [ChatGPT for Excel](/chatgpt-for-excel/)
...
2. Browse or search for GPTs
3. Click to start using
...
1. Click "Create" in the GPT explorer
2. Describe what you want (ChatGPT helps you build it)
3. Add instructions, knowledge files, and capabilities
4. Save and use (or share)
...
**Deep dive:** [Claude vs ChatGPT: Which Should You Use?](/claude-vs-chatgpt/)
...
**Fix:** Verify important facts. Ask "Are you sure about that?" or "What's your source?" Use [Perplexity](/perplexity-ai-guide/) for research that needs citations.
...
**Fix:** Set up [Custom Instructions](/chatgpt-custom-instructions/) once. Every conversation will be better.
...
**Deep dive:** [How to Use AI at Work Safely](/how-to-use-ai-at-work-safely/)
...
- [ChatGPT Release Notes](https://openai.com/blog)
