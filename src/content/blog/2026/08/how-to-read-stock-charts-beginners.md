...
author: "bored chap"
image: "../../../../assets/images/how-to-read-stock-charts-beginners.webp"
...
Shows four data points per time period: **O**pen, **H**igh, **L**ow, **C**lose. A vertical line shows the range, with small ticks marking open (left) and close (right).

**Good for:** More detail than line charts
**Bad for:** Cluttered and harder to read at a glance
