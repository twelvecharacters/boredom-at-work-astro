...
howTo:
  totalTime: "PT10M"
  steps:
    - name: "Choose your sideloading method"
      text: "Decide between Send to Kindle (web, email, or desktop app), USB transfer, Calibre, or the Chrome extension based on your needs."
    - name: "Prepare your files"
      text: "Make sure your files are in a supported format: EPUB, PDF, DOCX, TXT, RTF, HTML, or AZW3. DRM-protected EPUBs from other stores won't work."
    - name: "Send or transfer the files to your Kindle"
      text: "Upload via amazon.com/sendtokindle, email to your @kindle.com address, drag into the Send to Kindle desktop app, or connect via USB and copy to the documents folder."
    - name: "Verify files on your Kindle"
      text: "Open your Kindle library and confirm the sideloaded books appear. Files sent via Send to Kindle sync across all devices; USB transfers stay on that device only."
faq:
  - question: "Can I sideload EPUB files on a Kindle?"
    answer: "Yes! Since late 2022, Kindle supports EPUB natively. Send any DRM-free EPUB via Send to Kindle (web, email, or app) and Amazon auto-converts it to its own format. DRM-protected EPUBs from other stores like Kobo won't work."
...
|--------|-----------|-------|
| **EPUB** | ✅ | Native support since late 2022. Auto-converts to AZW3/KFX via Send to Kindle |
| **PDF** | ✅ | Works but not ideal for small screens |
| **DOCX** | ✅ | Word documents |
| **TXT** | ✅ | Plain text |
| **RTF** | ✅ | Rich text |
| **HTML** | ✅ | Web pages |
| **AZW3 / KFX** | ✅ | Amazon's native formats |
| **MOBI** | ❌ | Deprecated since August 2022 |
...
1. Go to [amazon.com/sendtokindle](https://www.amazon.com/sendtokindle) in any browser.
...
- **Online:** Go to [amazon.com/myk](https://www.amazon.com/myk) > Devices > select your Kindle
...
**Pro tip:** Add your Kindle email to your contacts so you can send files in seconds. If you have a lot of [free books](/free-books-kindle/) from Project Gutenberg or Standard Ebooks, this is the fastest way to get them onto your device.
...
[Calibre](https://calibre-ebook.com/) is free, open-source software that manages your entire ebook collection. It's the Swiss Army knife of ebook tools.
...
It's also the best option if you've downloaded books from places like [Project Gutenberg or Standard Ebooks](/free-books-kindle/) and want to clean up formatting before sending.
...
1. Install the [Send to Kindle extension](https://chrome.google.com/webstore) from the Chrome Web Store.
...
| Method | Ease of Use | Syncs Across Devices | Format Conversion | Max File Size | Best For |
|--------|-------------|---------------------|-------------------|---------------|----------|
| **Send to Kindle (Web)** | ⭐⭐⭐⭐⭐ | ✅ Yes | ✅ Auto | 200 MB | Quick one-off uploads |
| **Email** | ⭐⭐⭐⭐ | ✅ Yes | ✅ Auto | 200 MB | Sending from phone |
| **Desktop App** | ⭐⭐⭐⭐ | ✅ Yes | ✅ Auto | 200 MB | Batch transfers |
| **USB Transfer** | ⭐⭐⭐ | ❌ No | ❌ Manual | Unlimited | Offline / privacy |
| **Calibre** | ⭐⭐ | ✅ Via email | ✅ Manual + auto | Unlimited | Large libraries, power users |
| **Chrome Extension** | ⭐⭐⭐⭐⭐ | ✅ Yes | ✅ Auto | N/A | Web articles |
